...
function HomePage() {
    return (
        <div className="flex flex-col items-center justify-center md:h-screen px-2 text-white">
            <h1 className="text-5xl font-bold mb-10 mt-10 md:mb-20">ChatGPT</h1>

            <div className='md:flex space-x-2 ml-2 mr-2 text-center'>
